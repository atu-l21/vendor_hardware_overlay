package com.milankragujevic.qti.audio;
...
public class Service extends android.app.Service {
	...
	@Override public void onCreate() {
		...
		new java.lang.Thread() {
			@Override
			public void run() {
				android.util.Log.d("MilanKragujevic", "Hello");
				try {
                    ...
                    try {
                        (new UEventObserver() {
                            ...
                            public void onUEvent(UEventObserver.UEvent event) {
                                try {
                                    android.util.Log.v("MilanKragujevic", "USB UEVENT: " + event.toString());
                                    ...
                                    android.util.Log.v("MilanKragujevic", "Got ringing = " + ringing + ", silent = " + silent + ", vibrate = " + vibrate);
                                    ...
                                    android.util.Log.d("MilanKragujevic", "Failed parsing uevent", e);
                                }

                            }
                        }).startObserving("DEVPATH=/devices/platform/soc/soc:tri_state_key");
                    } catch(Exception e) {
                        android.util.Log.d("MilanKragujevic", "Failed setting UEventObserver", e);
                    }
                }
    ...
    vendor.qti.hardware.radio.am.V1_0.IQcRilAudioCallback cb = new vendor.qti.hardware.radio.am.V1_0.IQcRilAudioCallback.Stub() {
        ...
        public String getParameters(String parameter) {
            android.util.Log.d("MilanKragujevic", "Got getParameters " + parameter);
            try {
                return AudioSystem.getParameters(parameter);
            } catch(Exception e) {
                android.util.Log.d("MilanKragujevic", "Failed getting parameters");
            }
            return "";
        }
        ...
        public int setParameters(String parameters) {
            android.util.Log.d("MilanKragujevic", "Got setParameters " + parameters);
            try {
                AudioSystem.setParameters(parameters);
            } catch(Exception e) {
                android.util.Log.d("MilanKragujevic", "Failed setting parameters");
            }
            return 0;
        }
    };
